...
This script implements multi-language support for KeepChatGPT

# Usage Instructions:

## Step 1:
Identify the text to be localized, for example:
Suggested interval 30 seconds

## Step 2:
Translate into temporary language packs for each country. Send the following command to ChatGPT:
ar,bg,cs,da,de,el,en,eo,es,fi,fr,fr-CA,he,hu,id,it,ja,ka,ko,nb,nl,pl,pt-BR,ro,ru,sk,sr,sv,th,tr,uk,ug,vi,zh-CN,zh-TW
Translate one sentence according to the above country order and output line by line according to my required format
Format requirements: country abbreviation: translated text
The first letter after the colon needs to be capitalized
For example, the result of translating "Show debug" is: en: Show debug window
Next, please translate: Suggested interval 30 seconds

## Step 3:
Configure the following variables in this script:
lang: Copy and paste the lang variable value from KeepChatGPT here
new_str: Fill in the text to be localized, e.g. "Suggested interval 30 seconds"
new_str_min: Fill in English abbreviation for the localized text, e.g. "si"
transle_tmp: Copy and paste ChatGPT's translation results here

## Step 4:
Run and copy/paste the results into the lang variable in KeepChatGPT.
"""
...
"ja": {"dm": "ダークモード", "sd": "デバッグを表示", "cm": "監査をキャンセル", "ca": "アニメーションのキャンセル", "ab": "について", "si": "50秒間隔を提案する", "mi": "間隔を変更する", "cu": "更新をチェックする", "cv": "現在のバージョン", "dl": "最新バージョンを発見する", "lv": "最新バージョンです", "cc": "会話をクローンする", "pp": "ページを浄する", "ls": "ビッグスクリーンを表示する", "sc": "完全に話してください", "it": "トラッキングの傍受", "ec": "絶え間ない変化", "ap": "評価", "wn": "警告", "ds": "データセキュリティ", "dd": "機密データを発見する", "rr": "正規表現を使用してルールを書く", "ko": "鋭い観察"},
"ka": {"dm": "ბნელი რეჟიმი", "sd": "გამოჩენა დებაგი", "cm": "ანულირება აუდიტი", "ca": "ანიმაციის გაუქმება", "ab": "შესახებ", "si": "50 წამის ინტერვალის შეტანა", "mi": "ინტერვალის შეცვლა", "cu": "განახლებების შემოწმება", "cc": "კონვერსაციის კლონირება", "pp": "გვერდის გაწმენდა", "ls": "დდი ეკრანის გამოსახულება", "sc": "სრულად ილაპარაკეთ", "it": "თვალყური მისმართავა", "ec": "მუდმივი ცვლილება", "ap": "შეფასება", "wn": "გაფრთხილება", "ds": "მონაცემთა უსაფრთხოება", "dd": "საკითხავი მონაცემების გამოცნობა", "rr": "გამოიყენეთ regex წესების დაწერად", "ko": "მკრეფად გამოვიდა"},
