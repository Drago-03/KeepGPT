...
// @version           2.6
// @author            Drago
// @namespace         https://github.com/Drago-03/KeepGPT/
// @supportURL        https://github.com/Drago-03/KeepGPT/
...
// @description:ko    이것은 ChatGPT의 데이터 보안 기능과 효율성을 향상시키는 애드온으로, 자동 새로 고침, 활동 보존, 데이터 보안, 감사 취소, 대화 복제, 무제한 문자, 홈페이지 정화, 대형 화면 표시, 전체 화면 표시, 추적 가로채기 등의 혁신적인 기능을 무료로 공유��니다. 끊임없이 진화하며 더 많은 기능을 제공합니다.
...
/* 
 * Author: Drago
 * Modified version of KeepChatGPT
 * Original author: xcanwin
 */
...
(function() {
    ...
    // Add Drago's name to the page
    const addDragoName = function() {
      const dragoDiv = document.createElement('div');
      dragoDiv.style.position = 'fixed';
      dragoDiv.style.bottom = '10px';
      dragoDiv.style.right = '10px';
      dragoDiv.style.padding = '5px';
      dragoDiv.style.background = '#333';
      dragoDiv.style.color = '#fff';
      dragoDiv.style.borderRadius = '5px';
      dragoDiv.style.zIndex = '9999';
      dragoDiv.textContent = 'Modified by Drago';
